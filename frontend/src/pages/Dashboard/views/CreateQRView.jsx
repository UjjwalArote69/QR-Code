...
const CreateQRView = () => {
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      {/* Main Scrolling Area */}
      <div className="flex-1 overflow-y-auto p-8 scrollbar-hide bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      {/* RIGHT PREVIEW PANE */}
      <aside className="w-[450px] border-l border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex flex-col items-center py-8 px-4 shrink-0 overflow-y-auto transition-colors duration-300">
        <h2 className="text-lg font-medium text-slate-800 dark:text-slate-200 mb-8">Example</h2>
        <div className="relative w-[320px] h-[650px] rounded-[3rem] border-[12px] border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-950 shadow-xl dark:shadow-2xl flex items-center justify-center overflow-hidden transition-colors duration-300">
          ...
          <div className="absolute top-32 -left-[14px] w-1 h-12 bg-slate-300 dark:bg-slate-800 rounded-l-md transition-colors duration-300"></div>
          <div className="absolute top-48 -left-[14px] w-1 h-12 bg-slate-300 dark:bg-slate-800 rounded-l-md transition-colors duration-300"></div>
          <div className="absolute top-40 -right-[14px] w-1 h-16 bg-slate-300 dark:bg-slate-800 rounded-r-md transition-colors duration-300"></div>
        </div>
      </aside>
    </div>
  );
